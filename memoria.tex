...
A continuación se muestra la arquitectura general de Dr. Scratch:
	 \begin{figure}[H]
  		\centering
 		 \includegraphics[width=9cm, keepaspectratio]{img/arquitectura.jpg}
...
\section{Diseño e implementación del back-end}
	...
	\subsection{Organizaciones} 
		...
		\begin{itemize}
					...
					\item Modificación del procesador de Dead Code
				\end{itemize}
	
	\subsection{Modificación del procesador de Dead Code} 
	Debido a que se ha modificado el plugin de Dead Code de Hairball, la salía que ofrecía dicho plugin ya no 
		\begingroup
	...
	Dr. Scratch tiene una cuenta Twitter y en Wordpress, donde se interactúa con los diferentes usuarios y se escriben entradas sobre los talleres que realizamos o las actualizaciones de la web. Sin embargo, queríamos incluir una parte de foro donde la gente que use Dr. Scratch pueda opinar sobre él. Para ello, se creó la siguiente función en el fichero views.py:
...
\section{Diseño e implementación del front-end}
	\begin{itemize}
			\item Nuevos dashboards(muy tocho)Bootstrap tour, plyploma, popups, twitter
			\item Páginas de ayuda
			\item Estadísticas(muy tocho)
			\item Organizaciones(muy tocho)
			\item Validación de formularios vía AJAX
			\item Foro
	\end{itemize}
