...
\begin{enumerate}
  \item Crear cuentas de profesores para que puedan agrupar a sus alumnos. 
   \item Crear una red social dentro de Dr. Scratch, de tal manera que puedan comentar las puntuaciones que han sacado y lanzarse retos.
    \item 
\end{enumerate}
